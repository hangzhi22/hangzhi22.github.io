...
/***/ function (module, exports, __webpack_require__) {
	...
	*/
            ...
            (function (e, r) { true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (r), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : typeof module === 'object' && module.exports ? module.exports = r() : e.anime = r() })(this, function () {
	...
	0; g.progress = 0; g.paused = !0; g.began = !1; g.completed = !1; g.reversed = a === 'reverse'; g.remaining = a === 'alternate' && c === 1 ? 2 : c; b(0); for (a = g.children.length; a--;)g.children[a].reset()
                    ...
                    col: function (a) { return h.hex(a) || h.rgb(a) || h.hsl(a) } }; var A = (function () {
                    function a (a,
	...
	0)k = l; else { var l = h; var h = h + 0.1; var g = 0; do m = l + (h - l) / 2, n = a(m, c, b) - k, n > 0 ? h = m : l = m; while (Math.abs(n) > 1e-7 && ++g < 10);k = m } return a(k, d, f)
                    ...
                    function a (a, b) { return a === 0 || a === 1 ? a : -Math.pow(2, 10 * (a - 1)) * Math.sin(2 * (a - 1 - b / (2 * Math.PI) * Math.asin(1)) * Math.PI / b) } var c = 'Quad Cubic Quart Quint Sine Expo Circ Back Elastic'.split(' '); var d = { In: [[0.55, 0.085, 0.68, 0.53], [0.55, 0.055, 0.675, 0.19], [0.895, 0.03, 0.685, 0.22], [0.755, 0.05, 0.855, 0.06], [0.47, 0, 0.745, 0.715], [0.95, 0.05, 0.795, 0.035], [0.6, 0.04, 0.98, 0.335], [0.6, -0.28, 0.735, 0.045], a],
                        ...
                        InOut: [[0.455, 0.03, 0.515, 0.955], [0.645, 0.045, 0.355, 1], [0.77, 0, 0.175, 1], [0.86, 0, 0.07, 1], [0.445, 0.05, 0.55, 0.95], [1, 0, 0, 1], [0.785, 0.135, 0.15, 0.86], [0.68, -0.55, 0.265, 1.55], function (b, c) { return b < 0.5 ? a(2 * b, c) / 2 : 1 - a(-2 * b + 2, c) / 2 }] }; var b = { linear: A(0.25, 0.25, 0.75, 0.75) }; var f = {}; var e; for (e in d) {
